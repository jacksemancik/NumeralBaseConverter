...
#This programme runs using the following shell command: `python conv.py other_num system` Works up to base-61.
#Letters represent numbers incrementally. For example, a = 10, b = 11, c = 12, etc. A = 36

#non-decimal 10 in decimal
system = int(sys.argv[2])

if(10 > system):
    #non-decimal system number
    other_num = int(sys.argv[1])
